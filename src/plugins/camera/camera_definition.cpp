...
CameraDefinition::parse_options(const tinyxml2::XMLElement *options_handle,
...
CameraDefinition::parse_range_options(const tinyxml2::XMLElement *param_handle,
                                      const std::string &param_name,
                                      std::map<std::string, std::string> &type_map)
{
    std::vector<std::shared_ptr<Option>> options{};
...
std::pair<bool, CameraDefinition::Option>
CameraDefinition::find_default(const std::vector<std::shared_ptr<Option>> &options,
